...
public class Solution {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Solution)) return false;  //1. ! - добавил

        Solution solution1 = (Solution) o;

        if (Double.compare(solution1.aDouble, aDouble) != 0) return false;
        if (anInt != solution1.anInt) return false;
        if (date != null ? !date.equals(solution1.date) : solution1.date != null) return false;                  // - добавил второй !
        if (solution != null ? !solution.equals(solution1.solution) : solution1.solution != null) return false;  // - добавил второй !
        if (string != null ? !string.equals(solution1.string) : solution1.string != null) return false;           // - добавил второй !
